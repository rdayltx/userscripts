// ==UserScript==
// @name         Tabela para Planilha XLSX 1.0
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Extrai dados de uma tabela e exporta para um arquivo XLSX
...
function main() {
    ...
    function scrapeTable() {
        ...
        const rows = table ? table.querySelectorAll('.andes-table__row.orders-table__row') : [];
        const pageData = [];
        rows.forEach(row => {
            const rowData = [];
    ...
    button.textContent = 'Exportar Tabela para XLSX';
